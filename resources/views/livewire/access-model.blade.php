                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (in_array('Add-More', $page_action))
                                            <a href="/access-point/{{ $row->id }}" class=" btn btn-success btn-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" wire:model="new_access_model"
                                placeholder="Access-Model">
                            @error('new_access_model')
